...
public class SociosController {
	...
	public static void crearSocio(String nombre, String apellido1, String apellido2, String nif, String email,
			String direcion, boolean estado) {
		try (Session session = HibernateUtil.buildSessionFactory().openSession()) {
	...
	public static void actualizarSocio(int id, String nombre, String apellido1, String apellido2, String nif,
