...
public class UsersController {
	...
	public static void actualizarUsuario(int id, String nombre, String apellido1, String apellido2, String nif,
	...
	public static void createDefaultAdminUser(SessionFactory sessionFactory) {
		try (Session session = sessionFactory.openSession()) {
			...
			Users adminUser = session.createQuery("FROM Users WHERE email = :email", Users.class)
					.setParameter("email", "admin@aavv.com").uniqueResult();
	...
	// Método para convertir una cadena de texto a SHA-256 obtenido de
	// https://trellat.es/codificar-texto-sha-256-java/
