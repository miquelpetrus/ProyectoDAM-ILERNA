...
public class UsersView extends javax.swing.JPanel {
		...
		try (Session session = sessionFactory.openSession()) {
			...
			try {
				...
				for (Users user : users) {
					tableModel.addRow(new Object[] { user.getId(), user.getName(), user.getApellido1(),
							user.getApellido2(), user.getNif(), user.getEmail(), user.getPassword() });
				}
	...
	private void initComponents() {
		...
		jTableUsers.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "id", "Nombre", "Apellido 1", "Apellido 2", "NIF", "Email", "Rol", "Password" }) {
				...
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGap(133, 133, 133)
										.addComponent(jButtonCerrar1, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(18, 18, 18)
										.addComponent(jButtonCrearNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(0, 0, Short.MAX_VALUE)))
						.addContainerGap())
				.addGroup(layout
						.createSequentialGroup().addGap(166, 166, 166).addComponent(jLabel1,
