...
public class ProductosView extends javax.swing.JPanel {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        // TODO add your handling code here:
            ...
            AddProductosView addProductosView = new AddProductosView();

            // Crear un nuevo JFrame para la ventana de socios
            JFrame addProductosFrame = new JFrame("Añadir nuevo producto");
            addProductosFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            addProductosFrame.getContentPane().add(addProductosView);
            addProductosFrame.pack();
            addProductosFrame.setVisible(true);
            addProductosFrame.setLocationRelativeTo(null);
 ...
 // Método para abrir la vista de edición con los datos de la fila
    private void abrirVistaEdicion(Object[] datosFila) {
        ...
        EditarProductosView editarProductoView = new EditarProductosView(datosFila);

        // Crear un nuevo JFrame para la ventana de edición
        ...
        editarProductoFrame.getContentPane().add(editarProductoView);
        editarProductoFrame.pack();
